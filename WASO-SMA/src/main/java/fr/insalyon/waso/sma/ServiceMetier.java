        ...
        try {
            ...
            for (JsonElement clientJsonElement : jsonOutputClientListe.getAsJsonArray()) {
                ...
                for (JsonElement personneID : personnesID) {
                   ...
                   // JsonArray PersonneListe = personneContainer.getAsJsonArray("personnes");
                    //outputPersonnes.add(PersonneListe);
                    
                    outputPersonnes.add(personneContainer.get("personnes"));
                }
                /*
                for(int i=0; i<outputPersonnes.size();i++){
                    
                        client.add("personnes", outputPersonnes.get(i));
